...
v0.4.1では、初回設定でサンプルを選ぶだけでなく、名前・目標値・単位を自由に入力して最大3件の行動を作成できます。まとめて日次報告、5つの成長ステータス、土日祝日対応カレンダー、通知、アプリ内更新も提供します。未報告日は失敗として扱いません。
...
- `Habitama-0.4.1.apk`
- `version.json`
- `Habitama-0.4.1.sha256`
- `Habitama-0.4.1-cert.txt`
...
公開先は[`toshiwd/Habitama`](https://github.com/toshiwd/Habitama)、今回のタグは`v0.4.1`です。公開時はAPKと`version.json`を必ず同じReleaseへ添付します。
